...
class Timer():
    """
    Timer class to be used as a context manager wrapped around code block
    to time. destructor automatically calls time, calulates and prints difference.
    with Timer() as t:
        for i in range(1,1000):
            pass
    # timer has stopped and printed result
      elapsed_time is available outside of context
...
def get_timer(device: torch.device = None):
    return Timer(device)